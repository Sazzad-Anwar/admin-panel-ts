...
const Dashboard: FC = () => {
    ...
    const { data: Users, isLoading } = useSWR('/users?_start=0&_limit=5', fetcher);
    const { data: Blogs, isLoading: blogLoading } = useSWR('/posts?_start=0&_limit=5', fetcher);
        ...
        <>
            ...
            >
                ...
                <Statistic
                    ...
                    title={
                        <span className="text-base font-semibold text-blue-500">Total balance</span>
                    }
                    value={112893}
                    formatter={formatter}
                />
                <Statistic
                    ...
                    title={
                        <span className="text-base font-semibold text-green-500">Total posts</span>
                    }
                    value={112893}
                    formatter={formatter}
                />
                <Statistic
                    ...
                    title={
                        <span className="text-base font-semibold text-red-500">Total stocks</span>
                    }
                    value={112893}
                    formatter={formatter}
                />
